<x-admin-layout>
    <div class="p-4 md:p-6">
        <div class="flex items-center justify-between mb-6">
            <div>
                <h1 class="text-2xl font-bold text-gray-800">Nuevo Punto de Venta</h1>
                <p class="text-gray-500 text-sm mt-1">Registrar un nuevo punto de venta</p>
            </div>
        ...
        <form method="POST" action="{{ route('points-of-sale.store') }}">
            @csrf
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-5 mb-5">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="code" value="{{ old('code') }}" required maxlength="5"
                ...
                <div class="border-t border-gray-100 mt-4 pt-4" x-data="{ isElectronic: {{ old('is_electronic') ? 'true' : 'false' }} }">
                    ...
                    <div x-show="isElectronic" x-transition class="mt-3">
                        ...
                        <input type="number" name="afip_pos_number" value="{{ old('afip_pos_number') }}" min="1" max="99999"

                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-2">
                                    <label class="flex items-center p-2 rounded hover:bg-blue-100 transition-colors">
                                        <input type="checkbox" name="base_items[]" value="basico"
                                               {{ in_array('basico', old('base_items', $selectedBaseItems ?? [])) ? 'checked' : '' }}
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-2">
                                    ...
                                    <label class="flex items-center p-2 rounded hover:bg-blue-100 transition-colors">
                                        <input type="checkbox" name="base_items[]" value="{{ $haber->id }}"
                                               {{ in_array($haber->id, old('base_items', $selectedBaseItems ?? [])) ? 'checked' : '' }}
                                               class="rounded border-gray-300 text-blue-600 shadow-sm focus:ring-blue-500">
                    ...
                    <div class="md:col-span-2 flex flex-wrap gap-6">
                        ...
                        <label class="flex items-center">
                            <input type="checkbox" name="hide_percentage_in_receipt" value="1" 
                                   {{ old('hide_percentage_in_receipt', $salaryItem->hide_percentage_in_receipt) ? 'checked' : '' }}

    ...
    <script>
        ...
        function invoiceEditForm() {
            ...
            return {
                ...
                addItem() {
                    this.items.push({ description: '', supply_id: '', quantity: 1, unit_price: 0, iva_rate: '21', lot_number: '', expiration_date: '', _supply_code: '', updates_stock: !this.hasLinkedDeliveryNotes() });
                },

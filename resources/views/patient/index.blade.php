<x-app-layout>
  ...
  <form class="ml-4 md:ml-6" action="{{route('patient.store')}}" method="POST">
    @csrf
    ...
    <div class="bg-white pb-4 px-2 rounded-lg shadow-lg ">
      ...
      <div class="mt-4 grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-6">
        ...
        <div class="sm:col-span-3 ">
          ...
          <div class="border-slate-400 border-2 rounded-lg justify-items-stretch flex flex-wrap">
            <span class="w-3/5 px-4 items-center flex bg-gray-300 rounded-l-lg">Fecha de nacimiento:</span>
            <input type="date" name="birth" id="birth" autocomplete="off" value="2000-01-01"

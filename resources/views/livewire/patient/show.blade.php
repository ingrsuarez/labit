            ...
            <div>
                <table class="border-collapse border border-slate-400 table-auto mt-6 rounded">
                    ...
                    <tr class="">
                        ...
                        <td class="px-2 py-2 border border-slate-300"><a href="{{route('patient.edit',['current_patient'=>$patient->patientId])}}" class="rounded-md bg-green-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Editar</a></td>
                    </tr>

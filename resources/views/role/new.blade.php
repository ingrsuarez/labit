        ...
        <div class="bg-color-transparent" id="accordionExample">
            ...
            <div
              class="border border-t-0 border-neutral-200 bg-white dark:border-neutral-600 dark:bg-neutral-800">
                ...
                data-te-parent="#accordionExample">
                    <div class="px-5 py-4">
                        <p class="mt-1 text-sm leading-6 text-gray-600">Listado de roles:</p>    
                            ...
                            <div>
                                <table class="border-collapse border border-slate-400 table-auto mt-6 rounded">
                                    ...
                                    <tr class="">
                                        ...
                                        <td class="px-2 border border-slate-300">{{ucfirst($role->guard_name)}}</td>                                        
                                        <td class="px-2 text-center border border-slate-300">{{$role->created_at}}</td>
                                        <td class="px-2 py-2 border border-slate-300">
                                            <a href="{{route('role.edit',['role'=>$role->id])}}" class="rounded-md bg-green-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                                                Editar
                                            </a>
                                        </td>
                                    </tr>

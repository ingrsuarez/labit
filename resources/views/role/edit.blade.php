    ...
    <div class="flex flex-col justify-start">
        ...
        <div class="bg-color-transparent" id="accordionExample">
                        ...
                        <div class="mx-2 mt-4 grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-8">
                            <div class="sm:col-span-4 border-slate-400 border-2 rounded-lg  ">
                                ...
                                <div class="justify-items-stretch flex flex-wrap">
                                    ...
                                    <input type="text" name="name" id="name" autocomplete="off" required autofocus value="{{$role->name}}"
                            ...
                            <div class="sm:col-span-4">
                                ...
                                <div class="border-slate-400 border-2 rounded-lg justify-items-stretch flex flex-wrap ">
                                    ...
                                    <input type="text" name="guard_name" id="guard_name" autocomplete="off" required value="{{$role->guard_name}}"
                                    class="w-4/6 flex rounded-r-md border-0 text-gray-900 shadow-sm  placeholder:text-gray-400 sm:text-sm focus:ring-2 focus:ring-inset focus:ring-indigo-600">
                                </div>
                            </div>
            ...
            class="border border-t-0 border-neutral-200 bg-white dark:border-neutral-600 dark:bg-neutral-800">
                ...
                data-te-parent="#accordionExample">
                    <div class="px-5 py-4">
                        <p class="mt-1 text-sm leading-6 text-gray-600">Permisos del Rol:</p>    
                                    ...
                                    <tr class="">
                                        ...
                                        <td class="px-2 py-2 border border-slate-300">
                                            @if($role->hasPermissionTo($permission->name))
                                                <a href="{{route('role.detachPermission',['role'=>$role->id,'permission'=>$permission->id])}}" class="rounded-md bg-red-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                                                    Quitar
                                                </a>
                                            @else
                                                <a href="{{route('role.attachPermission',['role'=>$role->id,'permission'=>$permission->id])}}" class="rounded-md bg-green-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                                                    Agregar
                                                </a>
                                            @endif
                                        </td>

    ...
    <div class="p-4 md:p-6"
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
            <div>
                ...
                <p class="text-gray-500 text-sm mt-1">Gestión de proveedores del sistema</p>
            </div>
            ...
            <div class="flex flex-col md:flex-row gap-3">
                <div class="flex-1 relative">
                    <input type="text" x-model.debounce.400ms="search"
                           placeholder="Buscar por nombre, razón social, CUIT o código..."
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th class="px-4 py-3 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Cond. IVA</th>
                            ...
                            @foreach($suppliers as $supplier)
                                <tr class="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td class="px-4 py-3 whitespace-nowrap">
                                        <a href="{{ route('suppliers.show', $supplier) }}" class="text-zinc-700 font-semibold hover:text-zinc-900 text-sm">
                                            {{ $supplier->name }}
                                        </a>
                                        @if($supplier->business_name)
                                            <div class="text-xs text-gray-400">{{ $supplier->business_name }}</div>
                                        @endif
                                    </td>
                                    ...
                                    <td class="px-4 py-3 whitespace-nowrap text-right text-sm space-x-2">
                                        <a href="{{ route('suppliers.show', $supplier) }}" class="text-gray-500 hover:text-zinc-700">Ver</a>
                                        <a href="{{ route('suppliers.edit', $supplier) }}" class="text-gray-500 hover:text-zinc-700">Editar</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
            ...
            @else
                <div class="p-12 text-center">
                    ...
                    <p class="mt-1 text-sm text-gray-500">Comenzá registrando tu primer proveedor.</p>
                    <div class="mt-4">
                        <a href="{{ route('suppliers.create') }}"

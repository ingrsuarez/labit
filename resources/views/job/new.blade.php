<x-manage>
    ...
    <div class="bg-white pb-4 px-2 w-fit lg:w-3/5 rounded-lg shadow-lg">
    ...
    <div class="bg-white mx-4 mt-2 pb-4 px-2 w-fit lg:w-2/5 rounded-lg shadow-lg ">
                ...
                <div>
                    <table class="border-collapse border border-slate-400 table-auto mt-6 rounded">
                        <thead class="border border-slate-300">
                            ...
                            <th class="bg-blue-300 px-2 border border-slate-300">Orden</th>
                        ...
                        <tr class="">
                            ...
                            <td class="px-2 border border-slate-300">{{$job->order}}</td>
                            ...
                            <td class="px-2 py-2 border border-slate-300">
                                <a href="{{route('job.edit',['job'=>$job->id])}}" class="rounded-md bg-green-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                                    Editar
                                </a>
                            </td>
                        </tr>

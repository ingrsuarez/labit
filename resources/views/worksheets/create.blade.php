<x-lab-layout>
<div class="container mx-auto px-4 py-6" x-data="worksheetForm()">
    <div class="mb-6">
        <a href="{{ route('worksheets.index') }}" class="text-teal-600 hover:text-teal-800 text-sm">&larr; Volver a Planillas</a>
        <h1 class="text-2xl font-bold text-gray-800 mt-2">Nueva Planilla de Trabajo</h1>
    </div>
    ...
    <form method="POST" action="{{ route('worksheets.store') }}" class="space-y-6">
        @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="name" id="name" value="{{ old('name') }}" required
                           ...
                           placeholder="Ej: Hematología, Orina Completa...">
                </div>
                <div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <div x-show="selectedTests.length === 0" class="text-center py-8 text-gray-400">
                <p>No hay determinaciones seleccionadas. Usá el buscador de arriba para agregar.</p>
            </div>

...
<head>
    <meta charset="UTF-8">
    <title>Resumen detallado muestras {{ $customer->name }}</title>
    <style>
        body { font-family: Arial, sans-serif; font-size: 8px; color: #333; }
        table.data { width: 100%; border-collapse: collapse; margin-top: 8px; }
        table.data th { background: #0891b2; color: #fff; padding: 4px 5px; text-align: left; font-size: 7px; text-transform: uppercase; }
        ...
        table.data tfoot td { font-weight: bold; background: #ecfeff; font-size: 9px; }
    </style>
    @include('partials.billing-summary-pdf-head')
</head>
<body>
    @include('partials.billing-summary-lab-header-pdf', [
        'reportTitle' => 'Facturación detallada muestras — '.$periodLabel,

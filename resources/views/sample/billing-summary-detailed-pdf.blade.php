...
<head>
    ...
    <style>
        ...
        th { background: #0891b2; color: #fff; padding: 4px 5px; text-align: left; font-size: 7px; text-transform: uppercase; }
        th.right { text-align: right; }
        td { padding: 3px 5px; border-bottom: 1px solid #eee; vertical-align: top; }
        td.right { text-align: right; }
        td.mono { font-family: monospace; }
        tfoot td { font-weight: bold; background: #ecfeff; font-size: 9px; }
    </style>
</head>
<body>

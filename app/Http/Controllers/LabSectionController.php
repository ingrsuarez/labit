...
use App\Services\LabDashboardService;
...
class LabSectionController extends Controller
{
    ...
    public function clinico(Request $request)
    {
        ...
        if ($request->user()?->can('santacruz.import')) {
            array_splice($items, 2, 0, [[
                'name' => 'Santa Cruz (FTP)',
                'description' => 'Sincronizar admisiones desde XML del cliente',
                'route' => route('lab.santa-cruz.sync'),
    ...
    public function veterinario()
    {
        $section = [
            ...
            'description' => 'Gestión de protocolos veterinarios, especies y veterinarias',
            'color' => 'amber',
            'items' => [
                [
                    'name' => 'Protocolos',
                ...
                [
                    'name' => 'Nuevo Protocolo',
                    'description' => 'Crear protocolo veterinario',
                    'route' => route('vet.admissions.create'),
                    'icon' => 'M12 9v3m0 0v3m0-3h3m-3 0H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z',
                ],
                [
                    'name' => 'Especies',
                    'description' => 'Gestión de especies animales',
                    'route' => route('species.index'),
                    'icon' => 'M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z',
                ],
                [
                    'name' => 'Nomenclador veterinario',
                    'description' => 'NBU y valores de referencia de prácticas veterinarias',
                    'route' => route('lab.veterinario.nomenclador'),
                    'icon' => 'M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z',
                ],
                [
                    'name' => 'Veterinarias',
                    'description' => 'Clientes tipo veterinario',
                    'route' => route('customer.index', ['type' => 'veterinario']),
                    'icon' => 'M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4',
                ],
                [
                    'name' => 'Resumen por período',
                    'description' => 'Protocolos por veterinaria — códigos y totales',
                    'route' => route('vet.billing-summary'),
                    'icon' => 'M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z',
                ],
            ],
        ];

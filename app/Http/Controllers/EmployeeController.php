...
class EmployeeController extends Controller
{
    public function new()
    {
        ...
        return view('employee.new', compact('employees', 'jobs', 'categories', 'users', 'companies'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $data['company_id'] = $data['company_id'] ?? active_company_id();
    ...
    public function edit(Employee $employee)
    {
        ...
        return view('employee.edit', compact('employee', 'jobs', 'employee_jobs', 'categories', 'users', 'companies'));
    }

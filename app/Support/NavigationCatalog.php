    ...
    public static function shortcuts(): array
    {
        return [
            ...
            [
                ...
                'route_names' => [
                    'cash-flow.index',
                    'cash-flow.settings.edit',
                    'cash-flow.settings.update',
                    'cash-flow.obligations.create',
                    'cash-flow.obligations.store',
                    'cash-flow.obligations.edit',
                    'cash-flow.obligations.update',
                    'cash-flow.obligations.destroy',
                ],
            ],
            [
                'key' => 'sales-hub',

...
> Última actualización: 2026-05-01 (PM: hotfix v1.65.1 planificada — etiquetas de protocolo para laboratorio veterinario)
...
| **En proceso** | — |
| **Próxima recomendada** | **v1.65.1** — Etiquetas de protocolo para laboratorio veterinario (hotfix, sin Designer) |
...
|---|---|---|---|---|
| 1 | **v1.65.1** | **Etiquetas de protocolo para laboratorio veterinario** | — | `pendientes/v1.65.1-etiquetas-lab-veterinario.md` |
...
> **Razonamiento del orden** (sesión PM 2026-05-01):
> 1. **v1.65.1 hotfix** — gap funcional, sin Designer, 30min-1h, ejecutar inmediatamente
> 2. v1.66.0 siguiente — visibilidad ejecutiva alta, requiere Designer (brief en `agent-bootstrap/handoffs/v1.66.0-pm-to-dev.md`)
> 3-5. Bloque temático de impuestos (v1.63.0 → v1.63.1 → v1.64.0) para no perder contexto técnico (asientos, plan de cuentas, percepciones)
...
**Hotfix v1.65.1 planificada (2026-05-01).** Cola priorizada con 5 pendientes:

1. **v1.65.1** — Etiquetas lab veterinario (hotfix, sin Designer, ~30min-1h) — **ejecutar ya**

...
| **En proceso** | — |
| **Próxima recomendada** | **v1.114.0** — Integración Space10 upload PDF lab clínico |
| **Pendientes en cola** | 1 prompt `v*` — v1.114.0 |
| **Completadas** | 171+ |
...
| Versión | Archivo |
|---|---|
| v1.114.0 | `v1.114.0-integracion-space10-upload-pdf-lab-clinico.md` |

...
> Última actualización: 2026-05-14 (**v1.99.1** completada en código: NC AFIP; **master**: **v1.98.3** hotfix presupuestos + **v1.99.0** deducciones RRHH en código; **develop**: alineado; **release** previo **v1.98.1** planilla pendientes / **v1.97.0** Santa Cruz FTP)
...
| **Última completada (cola agente)** | **v1.99.1** — Hotfix NC desde factura AFIP (`CreditNoteElectronicStoreTest`, timeouts SOAP, transacción); **v1.98.3** — Índice presupuestos; **v1.99.0** — Deducciones RRHH |
| **Hotfix aplicado** | **v1.99.1** (2026-05-14): NC electrónica desde factura — timeouts WSAA/WSFE, sin transacción abierta durante SOAP, UX submit en create. **v1.98.3** (2026-05-15): listado `/quotes`. **v1.98.2** (2026-05-14): ingesta API… |

...
> Última actualización: 2026-05-29 (**v1.109.2** KPIs productividad entregados/carga)
...
| Campo | Valor |
|---|---|
| **Versión actual (línea v1.x)** | **master**: **v1.109.2** (KPIs entregados/carga por rol + orden) |
| **Última completada (cola agente)** | **v1.109.2** — Entregados email_sent, carga cualquier rol, tabla por rol |
| **En proceso** | — |
...
| v1.98.1 | Planilla resultados pendientes: clínico + vet unificados; nueva pestaña; filtros | 2026-05-14 | (ver CHANGELOG) |
| v1.98.0 | Planilla global resultados pendientes (lab clínico): `pending-results`, presenters, tests | 2026-05-13 | (ver CHANGELOG) |
...
**v1.109.2** en **master** (2026-05-29). Cola `v*` vacía. Si aún no se aplicó v1.109.0: `php artisan db:seed --class=RrhhProductivityPermissionsSeeder` y `php artisan permission:cache-reset`.

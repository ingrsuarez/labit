...
> Última actualización: 2026-05-30 (**v1.112.0** home personalizado con aprendizaje de accesos)
...
| Campo | Valor |
|---|---|
| **Versión actual (línea v1.x)** | **develop**: **v1.112.0** (home personalizado con aprendizaje de accesos) |
| **Última completada (cola agente)** | **v1.112.0** — Home personalizado: cards por uso, tracking navegación, financiero en `/dashboard/financiero` |
| **En proceso** | — |

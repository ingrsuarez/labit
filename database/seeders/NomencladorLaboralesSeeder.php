...
class NomencladorLaboralesSeeder extends Seeder
{
    private const NOMENCLADOR_NAME = 'Nomenclador laborales';

    private const SOURCE_FILE = 'Nomenclador laborales.xlsx';
    ...
    public function run(): void
    {
        ...
        $this->command->info('Importación de nomenclador laborales completada.');
    }
    ...
    private function importNomenclador(string $filePath): void
    {
        ...
        $insurance = Insurance::firstOrCreate(
            ...
            [
                ...
                'nbu_value' => 1,
                'group' => null,
                'instructions' => 'Nomenclador de prácticas para empresas laborales. Importado desde docs/'.self::SOURCE_FILE,
            ]
        );

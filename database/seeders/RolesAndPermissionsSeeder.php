...
class RolesAndPermissionsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $comprasPermissions = [
            ...
            'purchase-service-categories.index', 'purchase-service-categories.create', 'purchase-service-categories.edit', 'purchase-service-categories.delete',
            'purchase-services.index', 'purchase-services.create', 'purchase-services.edit', 'purchase-services.delete',

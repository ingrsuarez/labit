...
Route::middleware([
    ...
    Route::middleware(['permission:lab.section'])->group(function () {
        ...
        Route::post('lab/a25/worklist/preview', [App\Http\Controllers\A25InterfaceController::class, 'previewWorklist'])->name('a25.worklist.preview');
        ...
        Route::post('lab/admissions/{admission}/space10', [App\Http\Controllers\LabAdmissionController::class, 'uploadSpace10'])->name('lab.admissions.space10');
    ...
    Route::middleware('can:ventas.section')->group(function () {
        ...
        Route::get('sales-invoices/{salesInvoice}/pdf', [App\Http\Controllers\SalesInvoiceController::class, 'pdf'])->name('sales-invoices.pdf');
    ...
    // =============================================
    // PERSONAL (requiere permiso personal.section)
    // =============================================
    Route::middleware('permission:personal.section')->group(function () {
        // EMPLOYEES
    ...
    }); // fin personal.section

    // =============================================
    // LIQUIDACIONES (requiere permiso liquidaciones.section)
    // =============================================
    Route::middleware('permission:liquidaciones.section')->group(function () {
        // SALARY ITEMS
    ...
    // =============================================
    // AUSENCIAS (requiere permiso ausencias.section)
    // =============================================
    Route::middleware('permission:ausencias.section')->group(function () {
        // VACATIONS
        ...
        Route::get('leave/resume-compact', [App\Http\Controllers\LeaveController::class, 'resumeCompact'])->name('leave.resume.compact');
        Route::get('leave/export/excel', [App\Http\Controllers\LeaveController::class, 'exportExcel'])->name('leave.export.excel');
        Route::get('leave/export/pdf', [App\Http\Controllers\LeaveController::class, 'exportPdf'])->name('leave.export.pdf');
    }); // fin ausencias.section

    // =============================================
    // CONFIGURACIÓN (requiere permiso configuracion.section)
    // =============================================
    Route::middleware('permission:configuracion.section')->group(function () {
        // USERS
        ...
        Route::get('users/attach/role', [App\Http\Controllers\UserController::class, 'attachRole'])->name('role.attach');
        Route::get('users/detach/role', [App\Http\Controllers\UserController::class, 'detachRole'])->name('role.detach');
        Route::post('users/sync-roles', [App\Http\Controllers\UserController::class, 'syncRoles'])->name('user.syncRoles');

        // ROLES
        Route::get('role/new', [App\Http\Controllers\RoleController::class, 'new'])->name('role.new');
        ...
        Route::delete('role/destroy/{role}', [App\Http\Controllers\RoleController::class, 'destroy'])->name('role.destroy');
        Route::get('role/permission/attach/{role}/{permission}', [App\Http\Controllers\RoleController::class, 'attachPermission'])->name('role.attachPermission');
        Route::get('role/permission/detach/{role}/{permission}', [App\Http\Controllers\RoleController::class, 'detachPermission'])->name('role.detachPermission');
        ...
        Route::delete('permission/destroy/{permission}', [App\Http\Controllers\PermissionController::class, 'destroy'])->name('permission.destroy');
        Route::post('permission/attach-role/{permission}/{role}', [App\Http\Controllers\PermissionController::class, 'attachRole'])->name('permission.attachRole');
        Route::delete('permission/detach-role/{permission}/{role}', [App\Http\Controllers\PermissionController::class, 'detachRole'])->name('permission.detachRole');
        Route::post('permission/generate-module', [App\Http\Controllers\PermissionController::class, 'generateForModule'])->name('permission.generateModule');
    }); // fin configuracion.section
});

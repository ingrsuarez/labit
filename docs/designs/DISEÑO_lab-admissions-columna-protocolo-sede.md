...
| Celda | `whitespace-nowrap` | Stack vertical con `flex flex-col gap-1.5`, `align-top`, `min-w-0`, ancho máximo razonable (`max-w-[10rem]` sm `max-w-[12rem]`) para que la tabla no exija tanto scroll horizontal. |
